...
exports.HrModule = HrModule = __decorate([
    (0, common_1.Module)({ imports: [prisma_module_1.PrismaModule, approvals_module_1.ApprovalsModule], controllers: [hr_controller_1.HrController], providers: [hr_service_1.HrService], exports: [hr_service_1.HrService] })
], HrModule);
