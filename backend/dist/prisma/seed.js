...
function hashPassword(plain) {
    return bcrypt_1.default.hashSync(plain, 12);
}
async function main() {
    ...
    const founder = await prisma.user.upsert({
        ...
        create: {
            ...
            roleId: roleMap[client_1.RoleName.SUPER_ADMIN],
    ...
    const cto = await prisma.user.upsert({
        ...
        create: {
            ...
            roleId: roleMap[client_1.RoleName.COMPANY_ADMIN],
            departmentId: deptEng.id,
            status: "ACTIVE",
        },
    });
    ...
    const lead = await prisma.user.upsert({
        ...
        create: {
            ...
            roleId: roleMap[client_1.RoleName.TEAM_LEAD],
            departmentId: deptEng.id,
            status: "ACTIVE",
        },
    });
    ...
    const frontendDev = await prisma.user.upsert({
        ...
        create: {
            ...
            roleId: roleMap[client_1.RoleName.DEVELOPER],
            departmentId: deptEng.id,
            status: "ACTIVE",
        },
    });
    ...
    const designer = await prisma.user.upsert({
        ...
        create: {
            ...
            roleId: roleMap[client_1.RoleName.UI_UX_DESIGNER],
    ...
    const qa = await prisma.user.upsert({
        ...
        create: {
            ...
            roleId: roleMap[client_1.RoleName.QA_ENGINEER],
            departmentId: deptEng.id,
            status: "ACTIVE",
        },
    });
    ...
    const hr = await prisma.user.upsert({
        ...
        create: {
            ...
            roleId: roleMap[client_1.RoleName.HR_MANAGER],
    ...
    const finance = await prisma.user.upsert({
        ...
        create: {
            ...
            roleId: roleMap[client_1.RoleName.FINANCE],
    ...
    const projSmartERP = await prisma.project.upsert({
        ...
        create: {
            ...
            status: client_1.ProjectStatus.DEVELOPMENT,
    ...
    await prisma.pointsLedgerEntry.createMany({
        data: [
            { userId: frontendDev.id, points: 15, reason: client_1.PointReason.TASK_COMPLETED, note: "Completed Task #102: Responsive Sidebar" },
            { userId: backendDev.id, points: 20, reason: client_1.PointReason.TASK_COMPLETED, note: "Completed Task #101: RBAC Guards & Audit Interceptor" },
            { userId: designer.id, points: 10, reason: client_1.PointReason.DAILY_UPDATE_SUBMITTED, note: "Submitted daily update & design kit" },
        ],
        skipDuplicates: true,
    });
